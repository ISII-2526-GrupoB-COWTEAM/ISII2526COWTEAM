...
namespace AppForSEII2526.API.DTOs.PurchaseDTO
{
    ...
    {
        public PurchaseForDetailDTO(int id, string applicationUserName, string applicationUserSurname, string deliveryAddress, DateTime purchaseDate, double totalPrice, IList<PurchaseDeviceDTO> purchaseDevices, PaymentMethodTypes paymentMethod)
